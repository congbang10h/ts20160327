...
Ext.define('Ext.ux.grid.FiltersFeature', {
     ...
     */
    menuFilterText : 'Lọc dữ liệu',
    /**
     * @cfg {String} paramPrefix
     * The url parameter prefix for the filters.
     * Defaults to <tt>'filterex'</tt>.
     */
    paramPrefix : 'filterex',
    /**
    ...
    createFilters: function() {
        ...
        fields.get = function(dataIndex){
			if (this.map && this.map[dataIndex])
				return this.map[dataIndex];
        	for(var i in this)
        		if (this[i].name==dataIndex)
        			return this[i];
        	return null;
        };
    ...
    saveState : function (grid, state) {
        ...
        return (state.filters = filters)?true:false;
    },
