...
NodeParser.prototype.paintText = function(container) {
    ...
    if (shadows.length) {
        // NTODO: support multiple text shadows
...
NodeParser.prototype.renderTextDecoration = function(container, bounds, metrics) {
    ...
    case "underline":
        ...
        // NTODO As some browsers display the line as more than 1px if the font-size is big, need to take that into account both in position and size
    ...
    case "overline":
        ...
        break;
    case "line-through":
        // NTODO try and find exact position for line-through
