	...
	return function(document, settings) {
		...
		function load(url, loadedCallback, errorCallback) {
			...
			if ("onload" in link && !isOldWebKit()) {
				...
				// NTODO: Remove this in the future when everyone uses modern browsers
...
define("tinymce/dom/DOMUtils", [
	...
	DOMUtils.prototype = {
		...
		clone: function(node, deep) {
			...
			// NTODO: Add feature detection here in the future
...
define("tinymce/html/Schema", [
	...
	function compileSchema(type) {
		...
		// HTML4 base schema NTODO: Move HTML5 specific attributes to HTML5 specific if statement
		...
		// NTODO: LI:s can only have value if parent is OL

		// NTODO: Handle transparent elements
	...
	return function(settings) {
		...
		// NTodo: Remove this when we fix list handling to be valid
...
define("tinymce/dom/Serializer", [
	...
	return function(settings, editor) {
		...
		// Fix list elements, NTODO: Replace this later
				...
				if (Env.ie >= 11) {
					...
					editor.dom.bind(rootElement, 'mscontrolselect', function(e) {
						if (/^(TABLE|IMG|HR)$/.test(e.target.nodeName)) {
							...
							// NTODO: Fix this the day IE works like other browsers without this nasty native ugly control selections.
	...
	function getCssText(editor, format) {
		...
		each(previewStyles.split(' '), function(name) {
			...
			if (name == 'background-color' && /transparent|rgba\s*\([^)]+,\s*0\)/.test(value)) {
				...
				// NTODO: Fix this by detecting runtime style
		...
		function apply(name, vars, node) {
			...
			function setElementFormat(elm, fmt) {
				...
				if (elm) {
					...
					// NTODO: Remove this once WebKit/Blink fixes this
					if (fmt.styles) {
			...
			function applyRngStyle(rng, bookmark, node_specific) {
				...
				rangeUtils.walk(rng, function(nodes) {
					...
					function process(node) {
						...
						// NTODO: Break this if up, too complex
...
define("tinymce/ForceBlocks", [], function() {
	return function(editor) {
		...
		function addRootBlocks() {
			...
			while (node) {
				// NTODO: Break this up, too complex
	...
	return function(editor) {
		...
		addCommands({
			...
			'InsertUnorderedList,InsertOrderedList': function(command) {
				...
				// NTODO: Remove this when the list creation logic is removed
			...
			mceInsertContent: function(command, ui, value) {
				...
				if (node && node.nodeType == 3) {
					...
					// NTODO: Why can't we normalize on IE
					if (!isIE) {
...
define("tinymce/ui/Control", [
	...
	var Control = Class.extend({
		...
		init: function(settings) {
			...
			// NTODO: Is this needed duplicate code see above?
			if (settings.classes) {
...
define("tinymce/ui/Container", [
	...
	return Control.extend({
		...
		focus: function(keyboard) {
			...
			// NTODO: Figure out a better way to auto focus alert dialog buttons
			if (self.statusbar) {
...
define("tinymce/ui/Movable", [
	...
	return {
		...
		moveTo: function(x, y) {
			...
			// NTODO: Move this to some global class
...
define("tinymce/util/Quirks", [
	...
	return function(editor) {
		...
		function cleanupStylesWhenDeleting() {
			...
			// NTODO: Remove this when old Safari versions gets updated
			if (!MutationObserver) {
				olderWebKit = true;
			...
			editor.on('touchstart', function(e) {
				...
				editor.once('touchend', function(e) {
					...
					if (!args.isDefaultPrevented()) {
						...
						// NTODO: Expand to the closest word? Touble tap still works.
...
define("tinymce/Editor", [
	...
	Editor.prototype = {
		...
		init: function() {
			...
			// Create iframe
			// NTODO: ACC add the appropriate description on this.
	...
	function FocusManager(editorManager) {
		function getActiveElement() {
			try {
				...
				// NTODO: Investigate this
				return document.body;
			}
		}

		// We can't store a real range on IE 11 since it gets mutated so we need to use a bookmark object
		// NTODO: Move this to a separate range utils class since it's it's logic is present in Selection as well.
...
define("tinymce/ui/ComboBox", [
	...
	return Widget.extend({
		...
		init: function(settings) {
			...
			self.subinput = true;
			self.ariaTarget = 'inp'; // NTODO: Figure out a better way
...
define("tinymce/ui/MenuButton", [
	...
	// NTODO: Maybe add as some global function
